...
//                                        'rightsDisplay' => 'none'
        ...
        'meliscore_login' => array(
            ...
            'datas' => array(
                ...
                'login_logo' => '/MelisCore/images/login/melis-log.svg',
            ),
            'interface' => array(
        ...
        'meliscore_lost_password' => array(
            ...
            'datas' => array(
                'login_background' => 'MelisCore/images/login/melis-blackboard.jpg',
                'lost_password_logo' => '/MelisCore/images/login/melis-logo-white-bg.svg',
            ),
            'interface' => array(
        ...
        'meliscore_reset_password' => array(
            ...
            'datas' => array(
                'login_background' => 'MelisCore/images/login/melis-blackboard.jpg',
                'reset_password_logo' => '/MelisCore/images/login/melis-logo-white-bg.svg',
            ),
            'interface' => array(
        ...
        'meliscore_generate_password' => array(
            ...
            'datas' => array(
                'login_background' => 'MelisCore/images/login/melis-blackboard.jpg',
                'generate_password_logo' => '/MelisCore/images/login/melis-logo-white-bg.svg',
            ),
            'interface' => array(
        ...
        'meliscore_renew_password' => array(
            ...
            'datas' => array(
                'login_background' => 'MelisCore/images/login/melis-blackboard.jpg',
                'renew_password_logo' => '/MelisCore/images/login/melis-svg.svg',
            ),
            'interface' => array(
