...
-- -----------------------------------------------------
-- Table `melis_core_platform_color`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `melis_core_platform_color` ;

CREATE TABLE IF NOT EXISTS `melis_core_platform_color` (
  `pcolor_id` INT NOT NULL AUTO_INCREMENT,
  `pcolor_settings` TEXT NULL,
  `pcolor_is_active` TINYINT(1) NULL DEFAULT 0,
  PRIMARY KEY (`pcolor_id`))
ENGINE = InnoDB;
