...
return [
    ...
    'tr_meliscore_dashboard_notify_step_1_msg' => "Click plugin menu button to <br>toggle the list of available plugins.",
    'tr_meliscore_dashboard_notify_step_2_msg' => "Click to toggle list of available plugins per <br>category that are draggable into the dashboard.",
    'tr_meliscore_dashboard_notify_steps_general_next_text' => "Next",
    'tr_meliscore_dashboard_notify_steps_general_skip_text' => "Skip",
    'tr_meliscore_dashboard_notify_step_2_next_text' => "Ok",
