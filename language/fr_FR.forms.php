<?php 
	return array(  
        ...
        'tr_meliscore_tool_user_usr_password_regex_not_match' => 'Votre mot de passe doit être de 12 caractères ou plus avec au moins une lettre minuscule et un chiffre',
