...
(function($, window) {
    var $body = $("body");
        ...
        $('[data-toggle="navbar-color"]').on('click', function(e){
            ...
            $(this).parent().find('[data-bs-toggle="navbar-color"].active').removeClass('active');
        ...
        $('.app [data-bs-toggle="tab"]').on('shown.bs.tab', function(e) {
        ...
        $body.on('click', 'ul.sideMenu li a[data-bs-toggle="collapse"]', function(){
