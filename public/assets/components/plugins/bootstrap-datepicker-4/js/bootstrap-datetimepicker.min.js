    ...
    return e.fn.datetimepicker = function(t) {
        ...
        keyBinds: {
            ...
            "control space": function(e) {
                e && e.find(".timepicker").is(":visible") && e.find('.btn[data-action="togglePeriod"]').trigger("click")
            },
            t: function() {
