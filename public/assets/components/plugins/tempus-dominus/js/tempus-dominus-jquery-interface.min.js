...
tempusDominus.jQueryInterface = function (option, argument) {
  ...
  const pname = 'tempusDominus';
  const JQUERY_NO_CONFLICT = $.fn[pname];
  $.fn[pname] = tempusDominus.jQueryInterface;
  $.fn[pname].Constructor = tempusDominus.TempusDominus;
  $.fn[pname].noConflict = function () {
    $.fn[pname] = JQUERY_NO_CONFLICT;
