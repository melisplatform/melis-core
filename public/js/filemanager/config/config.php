<?php
eval ('chdir("' . $_SERVER['DOCUMENT_ROOT'] . '/");');
@session_start();
...
|    |   |   |   |   |- plugin.min.js
*/
define('MELIS_CORE_FILE_MANAGER_PATH', $_SERVER['DOCUMENT_ROOT'] . '../vendor/melisplatform/melis-core/public/js/filemanager/');
...
$config = array(
	...
	*/
	...
	'image_resizing'                          => true,
	'image_resizing_width'                    => 300,
	'image_resizing_height'                   => 250,
	...
	*******************/
	...
	'hidden_folders'                          => array('filemanager'),
