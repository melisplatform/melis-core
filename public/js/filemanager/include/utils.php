...
if ( ! function_exists('trans'))
{
	...
	if(file_exists($_SERVER['DOCUMENT_ROOT'] . '/../vendor/melisplatform/melis-core/public/js/filemanager/lang/' . $lang . '.php')){
		$lang_vars = $_SERVER['DOCUMENT_ROOT'] . '/../vendor/melisplatform/melis-core/public/js/filemanager/lang/' . $lang . '.php';
	}else{
		$lang_vars = include $_SERVER['DOCUMENT_ROOT'] . '/../vendor/melisplatform/melis-core/public/js/filemanager/lang/' . $lang . '.php';
	}
	...
	*/
	...
	{
//		global $lang_vars;
        $lang_vars = include_once($_SERVER['DOCUMENT_ROOT'] . '/../vendor/melisplatform/melis-core/public/js/filemanager/lang/en.php');
