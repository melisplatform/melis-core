...
(function () {
  var minitemplate = (function () {
      ...
      var replaceVals = function (editor, e) {
        ...
        console.log("replaceVals dom: ", dom);
        console.log("replaceVals vl: ", vl);
      ...
      var insertTemplate = function (editor, ui, html) {
        ...
        console.log("minitemplate insertTemplate html: ", html);
      ...
      var open = function (editor, templateList) {
        ...
        var findTemplate = function (templates, templateTitle) {
          console.log("minitemplate findTemplate templates: ", templates);
          console.log("minitemplate findTemplate templateTitle: ", templateTitle);
          return find(templates, function (t) {
            //console.log("minitemplate findTemplate t.text: ", t.text);
        ...
        var onAction = function(templates) {
          return function (api, click) {
            //if (click.name === 'template') {
              //var newTemplateTitle = api.getData().template;
              var newTemplateTitle = click.name;
              
                console.log("minitemplate onAction click: ", click);
                console.log("minitemplate onAction newTemplateTitle: ", newTemplateTitle);
        ...
        /* var getPreviewedTemplateTitle = function(previewedTemplateTitle) {
          if ( previewedTemplateTitle !== '' ) {
            return previewedTemplateTitle;
          }
        }; */
        ...
        var onSubmit = function (templates) {
          return function (api) {
            var data = api.getData();
                ...
                console.log("minitemplate onSubmit api: ", api);
                console.log("minitemplate onSubmit api.getData(): ", data);
                console.log("minitemplate onSubmit templates: ", templates);
                console.log("minitemplate onSubmit data.template: ", data.template);
        ...
        var openDialog = function (templates) {
          ...
          /* var $body             = $("body"),
              $templateButtons  = $(".tox-form .tox-form__group .tox-button");

              $templateButtons.each(function() {
                var $this = $(this);

                    $this.on("click", function(e) {
                      console.log(".tox-button buttons clicked! length: ", $(this).length );
                      console.log(".tox-button e: ", e);
                    });
              }); */
        };
