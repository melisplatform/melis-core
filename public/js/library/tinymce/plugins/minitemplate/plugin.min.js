...
(function () {
  var minitemplate = (function () {
      ...
      var open = function (editor, templateList) {
        ...
        var createButtonItems = function (templates) {
          return map(templates, function (v) {
            //console.log("createButtonItems templates: ", templates);
            return {
              text: v.text,
              value: v.text
            }
        ...
        var openDialog = function (templates) {
          ...
          getTemplateContent(templates[0]).then(function (previewHtml) {
            console.log("getTemplateContent selectBoxItems: ", selectBoxItems);
            ...
            var bodyItems = [
              {
                ...
                //text: selectBoxItems[0].text // need to call a function that return this
              },
              {
                type: 'button',
                name: 'template',
                text: 'test'
                //text: selectBoxItems[1].text
              },
              {
                label: 'Preview',
                type: 'iframe',
