  ...
  var minitemplate = (function () {
      ...
      var open = function (editor, templateList) {
        ...
        var onSubmit = function (templates) {
          //console.log("onSubmit templates: ", templates);
          return function (api) {
            var data = api.getData();
            //console.log("onSubmit api data: ", data);
        ...
        var openDialog = function (templates) {
          ...
          //console.log("open openDialog: ", templates);
          //var buttonItems = createButtonItems(templates);
          //var createButtonItems = createButtonBodyItems(templates);
          var dialogSpec = function (bodyItems, initialData) {
            //console.log("dialogSpec bodyItems: ", bodyItems);
            return {
          ...
          getTemplateContent(templates[0]).then(function (previewHtml) {
            //console.log("openDialog getTemplateContent createButtonItems: ", createButtonItems);
            var content = getPreviewContent(editor, previewHtml);
            //console.log("getTemplateContent templates: ", templates);
            //console.log("getTemplateContent templates length: ", templates.length);
            var bodyItems = [];
