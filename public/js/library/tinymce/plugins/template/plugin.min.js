        ...
        var open = function (editor, templateList) {
          ...
          var onChange = function (templates) {
            return function (api, change) {
              console.log("open onChange api: ", api);
              console.log("open onChange change: ", change);
              if (change.name === 'template') {
                var newTemplateTitle = api.getData().template;
                console.log("open onChange api.getData(): ", api.getData() );
                console.log("open onChange api.getData().template: ", api.getData().template );
                console.log("onChange newTemplateTitle: ", newTemplateTitle);
          ...
          var onSubmit = function (templates) {
            return function (api) {
              ...
              console.log("template onSubmit api: ", api);
              console.log("template onSubmit data: ", data);
              console.log("template onSubmit data.template: ", data.template);
              console.log("template onSubmit templates: ", templates);
