    ...
    var minitemplate = (function () {
        ...
        var open = function (editor, templateList) {
          ...
          var openDialog = function ( templates ) {
            var entries = Object.entries(templates),
                ...
                for ( var [index, valueStr] of entries) {                 
                  var url = valueStr.value.url;
                      console.log('openDialog entries url != undefined: ', url != undefined);
                      if ( url != undefined ) {
                      //if ( ! url ) {
            ...
            console.log('openDialog getTemplateContent templates[nearestTemplateIndex]: ', templates[nearestTemplateIndex]);
