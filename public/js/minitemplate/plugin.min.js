    ...
    var minitemplate = (function() {
      ...
      tinymce.PluginManager.add("minitemplate", function(editor, url) {
        ...
        editor.ui.registry.addButton('minitemplate', {
          ...
          title: 'Mini Template',
          onAction: () => {
            console.log("addButton tinymce.activeEditor.windowManager.openUrl _urlDialogConfig.url: ", _urlDialogConfig.url);
        ...
        editor.ui.registry.addMenuItem('minitemplate', {
          ...
          title: 'Mini Template',
          onAction: () => {
            console.log("addMenuItem tinymce.activeEditor.windowManager.openUrl _urlDialogConfig.url: ", _urlDialogConfig.url);
            //dialogApi = editor.windowManager.openUrl(_urlDialogConfig);
            dialogApi = tinymce.activeEditor.windowManager.openUrl(_urlDialogConfig);
