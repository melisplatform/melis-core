<?php
	return [
		...
		'plugins' => [
		   ...
		   'searchreplace', 'visualblocks', 'code', 'fullscreen', 'insertdatetime', 'media', 'table', 'minitemplate' // 'youtube',
		],
		'external_plugins' => [
			'minitemplate' => '/MelisCore/js/minitemplate/plugin.min.js?v=20210325'
		],
        'image_advtab' => true,
        'toolbar' => 'insertfile undo redo | formatselect | forecolor | bold italic strikethrough underline | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image media | minitemplate code', // minitemplate before code, youtube
