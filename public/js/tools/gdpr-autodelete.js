var gdprAutoDelete = {
    dataTosave: [],
    getBootstrapCollapse: function() {
        var listConfig = document.getElementById("list-config-content"),
            $listConfigCollapse = new bootstrap.Collapse(listConfig);

            return $listConfigCollapse;
    },
    /**
