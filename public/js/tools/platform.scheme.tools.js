...
var rangeSliderSize = {
    ...
    setRangeSliderSize: function() {
        const sliders = [
            ...
            { 
                selectorMin: ".modal-nav-tabs-border-right-width-range-slider-min", 
                selectorValue: ".modal-nav-tabs-border-right-width-range-slider-value", // edited added -nav-tabs-
