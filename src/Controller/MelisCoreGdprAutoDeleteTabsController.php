...
class MelisCoreGdprAutoDeleteTabsController extends AbstractActionController
{
    ...
    public function renderConfigTabAction()
    {
        ...
        $view->setVariable('formCronConfig', $this->getGdprAutoDeleteService()->getAddEditCronConfigForm());
    ...
    public function renderAlertEmailTabAction()
    {
        ...
        $view->setVariable('melisCoreGdprAlertEmailDeleteForm', $this->getGdprAutoDeleteService()->getAddEditDeleteForm());
        // get config id
        $view->setVariable('configId', $this->getConfigId());
