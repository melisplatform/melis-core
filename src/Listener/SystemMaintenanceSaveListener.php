...
class SystemMaintenanceSaveListener extends MelisGeneralListener implements ListenerAggregateInterface
{
        ...
        $this->attachEventListener(
            ...
            function($e){
                ...
                $result = $this->dispatchPlugin(
                    $e,
                    'MelisCore\Controller\SystemMaintenanceProperties',
