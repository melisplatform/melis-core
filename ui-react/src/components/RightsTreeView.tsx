...
const CAP_I18N: Record<string, I18nKey> = {
  list: 'caps.list', create: 'caps.create', edit: 'caps.edit', delete: 'caps.delete', duplicate: 'caps.duplicate', export: 'caps.export', download: 'caps.download', remove: 'caps.remove', clear: 'caps.clear', run: 'caps.run', test: 'caps.test',
}
